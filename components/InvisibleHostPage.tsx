...
function getCoupleName(brief: HostBrief, fallback: string) {
...
function buildIntro(
  ...
  const date = getDateLabel(
    brief.weddingDate,
    locale,
    t("invisible.fallback.date"),
  );
  const reception = brief.receptionVenue.trim() || t("invisible.fallback.reception");

  if (locale === "es") {
    return `Hola, soy el asistente invisible de ${names}. Ya tengo la boda del ${date}, la ceremonia en ${brief.ceremonyVenue}, y la celebracion en ${reception}. Puedo ayudar a los invitados con horarios, vestimenta y llegada.`;
  }

  return `Hello, I am the invisible assistant for ${names}. I have the wedding on ${date}, the ceremony at ${brief.ceremonyVenue}, and the reception at ${reception}. I can help guests with timing, dress code, and arrival details.`;
}
...
function buildAnswer(
  ...
  const asksDate =
    ...
    normalized.includes("cu\u00E1ndo") ||
    normalized.includes("hora") ||
    normalized.includes("fecha");

  if (locale === "es") {
    if (asksDress) {
      return `Para la boda de ${names}, el codigo de vestimenta es ${dress}.`;
    }

    if (asksPlace) {
      return `La ceremonia es en ${brief.ceremonyVenue}. Despues, la celebracion sera en ${reception}.`;
    }
    ...
    if (asksDate) {
      return `La boda de ${names} es el ${date}.`;
    }
  ...
  if (asksDress) {
    return `For ${names}'s wedding, the dress code is ${dress}.`;
  }

  if (asksPlace) {
    return `The ceremony is at ${brief.ceremonyVenue}. Afterward, the reception will be at ${reception}.`;
  }
  ...
  if (asksDate) {
    return `${names}'s wedding is on ${date}.`;
  }
...
export function InvisibleHostPage() {
  ...
  const [brief, setBrief] = useState<HostBrief>(initialBrief);
  const [activeBrief, setActiveBrief] = useState<HostBrief>(initialBrief);
    ...
    setMessages([
      {
        id: 1,
        role: "host",
        text: buildIntro(payload, locale, t),
      },
    ]);
    setIsSaving(false);
  }
  ...
  return (
    <main className="min-h-screen bg-[color:var(--surface)]">
      ...
      <section className="px-5 pb-16 pt-24 sm:px-8 sm:pt-28 lg:px-20 lg:pb-20 lg:pt-32">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
          <div className="rounded-[var(--radius-lg)] bg-[color:var(--surface-container-lowest)] p-5 shadow-[var(--shadow-ambient)] sm:p-7">
            <p className="eyebrow">{t("invisible.hero.eyebrow")}</p>
            <h1 className="mt-4 font-[family-name:var(--font-newsreader)] text-[clamp(2.15rem,4.6vw,3.7rem)] leading-[1.04] text-[color:var(--on-surface)]">
              {t("invisible.hero.title")}
            </h1>
            <p className="mt-4 max-w-xl font-[family-name:var(--font-newsreader)] text-[1rem] leading-7 text-[rgba(26,28,26,0.72)]">
              {t("invisible.hero.body")}
            </p>

            <form onSubmit={generateChatbot} className="mt-7 space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <label className="soft-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateBrief("partnerOne", event.target.value)
                    }
                ...
                <label className="soft-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateBrief("partnerTwo", event.target.value)
                    }
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <label className="soft-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateBrief("weddingDate", event.target.value)
                    }
                    required
                  />
                </label>
              ...
              <label className="soft-field">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateBrief("ceremonyVenue", event.target.value)
                  }
              ...
              <label className="soft-field">
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateBrief("receptionVenue", event.target.value)
                  }
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <label className="soft-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateBrief("dressCode", event.target.value)
                    }
                ...
                <label className="soft-field">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateBrief("arrivalNote", event.target.value)
                    }
              ...
              <label className="soft-field">
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    updateBrief("extraNotes", event.target.value)
                  }
            ...
            <div className="flex items-center justify-between gap-4 rounded-[var(--radius-md)] bg-[rgba(255,255,255,0.72)] px-4 py-3">
              <div>
                ...
                <h2 className="mt-1 font-[family-name:var(--font-newsreader)] text-2xl text-[color:var(--on-surface)]">
                  {generated ? coupleName : t("invisible.chat.ready")}
                </h2>
              </div>
