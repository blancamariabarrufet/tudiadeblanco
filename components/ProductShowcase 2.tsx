...
const DEMO_DISPLAY_HOST = "demo.wedsite.studio";
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="WedSITE Studio product hero"
      >
        ...
        <div className="product-hero__stage">
          <BrowserFrame
            route="/"
            title="WedSITE Studio — live demo home"
          ...
          {sections.map((section) => (
            ...
            >
              ...
              <div className="product-feature__stage">
                <BrowserFrame
                  route={section.route}
                  title={`WedSITE Studio — ${section.id} preview`}
                />
              </div>
            </article>
          ))}
